...
def main() -> None:
    ...
    publisher_config = AlertPublisherConfig.from_env(
        app_name="publish-price-alerts",
        source_table_name="gold_price_movement_alerts",
        checkpoint_subdir="alerts/price_movements",
    )
    kafka_config = AlertKafkaConfig.from_env("alerts/kafka_price_movements")
